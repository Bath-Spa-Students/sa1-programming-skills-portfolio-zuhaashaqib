...
boys = ["Jake","Zac","Ian","Ron","Sam","Dave"]  #initialization of list
if "Sam" in boys:   #condition to check if 'Sam' is in the list
    print("Yes, Sam is in this list")   #output based on the above condition
